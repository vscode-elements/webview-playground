...
export const theme = [
  ...
  ["--vscode-gauge-background", "#0f4a85"],
  ["--vscode-gauge-border", "#0f4a85"],
  ["--vscode-gauge-errorBackground", "#0f4a85"],
  ["--vscode-gauge-errorForeground", "#ffffff"],
  ["--vscode-gauge-foreground", "#ffffff"],
  ["--vscode-gauge-warningBackground", "#0f4a85"],
  ["--vscode-gauge-warningForeground", "#ffffff"],
  ...
  ["--vscode-inlineEdit-gutterIndicator\.secondaryBorder", "#ffffff"],
  ...
  ["--vscode-prompt-frontMatter\.inactiveBackground", "#0f4a85"],
